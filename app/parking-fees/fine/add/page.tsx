import { addParkingFine } from "@/app/actions/parking-fines";
    ...
    <div className="min-h-full font-sans selection:bg-rose-500/30">
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold tracking-tight">เพิ่มรายการค่าปรับ</h1>
            <p className="text-zinc-500 dark:text-zinc-400 mt-2">
                กำหนดรายการค่าปรับเพื่อใช้คิดเงินเพิ่มเติมจากผู้ใช้บริการ
            </p>
        </div>
        ...
        <div className="bg-white dark:bg-[#121212] rounded-3xl shadow-sm border border-zinc-200 dark:border-zinc-800/80 p-8 md:p-10 ring-1 ring-zinc-900/5 dark:ring-white/5 relative overflow-hidden group">
            <form action={addParkingFine} className="space-y-6 relative z-10">
                ...
                <div className="space-y-2">
                    ...
                    name="description"
                    id="description"
                    placeholder="ปรับกรณีทำบัตรจอดรถหาย ..."
                    rows={3}
