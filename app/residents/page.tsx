...
export default async function ResidentsPage() {
  ...
  try {
    residents = await getResidents('private');
  } catch (err) {
        ...
        <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            <div className="flex items-center gap-3 mb-2">
              <h1 className="text-3xl font-bold tracking-tight">ข้อมูลลูกบ้าน/ผู้เช่า / ทะเบียนรถ</h1>
            ...
            <p className="text-zinc-500 dark:text-zinc-400">
              จัดการโปรไฟล์ลูกบ้าน/ผู้เช่า และบันทึกทะเบียนรถที่ได้รับอนุญาตให้เข้าออกพื้นที่ (Whitelist) แบบรวมกลุ่ม
            </p>
          </div>
        ...
        <div className="bg-white dark:bg-[#121212] rounded-3xl shadow-sm border border-zinc-200 dark:border-zinc-800/80 overflow-hidden ring-1 ring-zinc-900/5 dark:ring-white/5">
            <div className="overflow-x-auto">
                ...
                <thead>
                    ...
                    <th className="px-6 py-5 text-left text-xs font-semibold text-zinc-500 uppercase tracking-widest leading-relaxed">ข้อมูลลูกบ้าน/ผู้เช่า</th>
                ...
                <tbody className="divide-y divide-zinc-200 dark:divide-zinc-800">
                    ...
                    <tr>
                        <td colSpan={2} className="px-6 py-24 text-center">
                            ...
                            <p className="text-zinc-600 dark:text-zinc-300 font-semibold text-lg">ยังไม่มีข้อมูลในระบบ</p>
                            <p className="text-zinc-400 dark:text-zinc-500 text-sm mt-1 mb-6">บันทึกข้อมูลลูกบ้าน/ผู้เช่าและทะเบียนรถเพื่อให้อนุญาตเข้าออกสถานที่อัตโนมัติ</p>
